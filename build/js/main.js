$(function(){
    ...
    $('.main-slider').owlCarousel({
        ...
        onInitialized: function(){
            $('.main-slider').addClass('owl-carousel').css({'height':'auto', 'visibility': 'visible'});
        },
    });
    ...
    $('.thumb-slider').owlCarousel({
        ...
        onInitialized: function(){
            $('.thumb-slider').addClass('owl-carousel').css({'height':'auto', 'visibility': 'visible'});
        },
    });
    ...
    $('.partners-slider').owlCarousel({
        ...
        onInitialized: function(){
            $('.partners-slider').addClass('owl-carousel').css({'height':'auto', 'visibility': 'visible'});
        },
    });
